...
def inference_op(input_op, keep_prob):
    ...
    pool3 = mpool_op(conv3_4,   name="pool3",   kh=2, kw=2, dh=2, dw=2)
    ...
    pool4 = mpool_op(conv4_4,   name="pool4",   kh=2, kw=2, dh=2, dw=2)
    ...
    pool5 = mpool_op(conv5_4,   name="pool5",   kh=2, kw=2, dw=2, dh=2)
